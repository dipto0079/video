                       ...
                       <div class="movie-payer">
                        ...
                        <?php endif; ?>
                           ...
                           <!-- seek remember -->
                            ...
                            <script>
                              ovoo_player.remember({"localStorageKey": "videojs.remember.<?php echo "tvs".$video_file->episodes_id; ?>"});
                            </script>
                           <script>
                                ovoo_player.on('timeupdate', onVideoTimeupdate );
                                function onVideoTimeupdate() {
                                    var percentage = ( ovoo_player.currentTime() / ovoo_player.duration() ) * 100;
                                    localStorage.setItem("cfs.<?php echo $video_file->episodes_id; ?>", percentage);
                                };
                            </script>
                ...
                <div class="col-lg-5">
                    <div class="movie-details style-1">
                        ...
                        <div class="description">
                            <p><span>Description:</span><p class="show-read-more"><?php echo $watch_videos->description;?> </p></p>
    ...
    <div class="section-content">
        <div class="container">
            <div class="title border-bottom">
                <div class="left-content">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $key == 0? 'active':''?>" id="<?php echo $season['seasons_name']; ?>-tab" data-toggle="tab" href="#<?php echo $season['seasons_name']; ?>" role="tab" aria-controls="<?php echo $season['seasons_name']; ?>" aria-selected="true"><?php echo $season['seasons_name']; ?></a>
                        </li>
                        <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>                            
            ...
            <div class="tab-content">
                ...
                ?>
                <div class="tab-pane fade <?php echo $key == 0? 'show active':''?>" id="<?php echo $season['seasons_name']; ?>" role="tabpanel" aria-labelledby="<?php echo $season['seasons_name']; ?>-tab">
                            ...
                            <div class="sg-video">
                                <div class="thumb">
                                    <a href="<?php echo base_url().'watch/'.$watch_videos->slug.'.html?key='.$episode['stream_key']; ?>">
                                        <img src="<?php echo base_url('uploads/default_image_flix/image_336X190.png'); ?>" alt="<?php echo $episode['episodes_name']; ?>" class="img-fluid lazy" data-src="<?php echo $this->common_model->get_episode_image_url($episode['episodes_id']); ?>">
                                    </a>
                                </div>
                                <h4><?php echo $episode['episodes_name']; ?></h4>
                            </div>
                        </li>
                        <?php endforeach; ?>
