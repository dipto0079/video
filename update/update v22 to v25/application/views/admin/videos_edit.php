<div class="card">
    <!-- <a class="btn btn-primary btn-xs pull-left waves-effect" href="<?php echo base_url('admin/videos'); ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>Back to List </a> -->
    <!-- <a class="btn btn-primary btn-xs pull-right waves-effect" href="<?php echo base_url('admin/videos'); ?>"> <span class="btn-label"><i class="fa fa-eye"></i></span>Preview </a> -->
    <div class="row">
        <div class="col-md-6">
            <?php 
