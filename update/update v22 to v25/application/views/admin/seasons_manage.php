<div class="card">
    <div class="row">
        <div class="col-sm-12">
            ...
            <a class="btn btn-sm btn-primary waves-effect" href="<?php echo base_url('tv-series/watch/').$slug; ?>" target="_blank"> <span class="btn-label"><i class="fa fa-eye"></i></span>Preview</a>
