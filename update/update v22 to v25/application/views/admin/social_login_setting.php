    <div class="card">
      <div class="row"> 
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-border panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo tr_wd('facebook_login_details'); ?></h3>
            </div>
            <div class="panel-body"> 
              <!-- panel  -->
              <div class="form-group">
                <label class="control-label col-md-3"><?php echo tr_wd('facebook_login'); ?></label>
                <div class="col-sm-8">              
                  <div class="animated-checkbox checkbox-inline">
                    <label>
                      <input type="checkbox" name='facebook_login_enable' value="1"  <?php if($this->db->get_where('config' , array('title' =>'facebook_login_enable'))->row()->value =='1'){echo 'checked';}?>><span class="label-text">Enable</span>
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('facebook_app_id'); ?></label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('facebook_app_secret'); ?></label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('facebook_graph_version'); ?></label>
                <div class="col-sm-8">
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-border panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo tr_wd('google_login_details'); ?></h3>
            </div>
            <div class="panel-body"> 
              <!-- panel  -->
              <div class="form-group">
                <label class="control-label col-md-3"><?php echo tr_wd('google_login'); ?></label>
                <div class="col-sm-8">              
                  <div class="animated-checkbox checkbox-inline">
                    <label>
                      <input type="checkbox" name='google_login_enable' value="1"  <?php if($this->db->get_where('config' , array('title' =>'google_login_enable'))->row()->value =='1'){echo 'checked';}?>><span class="label-text">Enable</span>
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('application_name'); ?></label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('client_id'); ?></label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('client_secret'); ?></label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label class=" col-sm-3 control-label"><?php echo tr_wd('google_redirect_uri'); ?></label>
                <div class="col-sm-8">
