    ...
    <div class="col-sm-12">
        <div class="btn-group dropdown pull-right">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo base_url().'admin/posts/published'?>"><?php echo tr_wd('published'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/posts/unpublished'?>"><?php echo tr_wd('unpublished'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/posts/'?>"><?php echo tr_wd('all_posts'); ?></a></li>
          </ul>
        </div>
          ...
          <tbody>
            ...
            <tr id='row_<?php echo $posts['posts_id'];?>'>                
              <td><div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a target="_blank" href="<?php echo base_url() . 'blog/'. $posts['slug'];?>"><?php echo tr_wd('preview'); ?></a></li>
                    <li><a  href="<?php echo base_url() . 'admin/posts_edit/'. $posts['posts_id'];?>"><?php echo tr_wd('edit_post'); ?></a></li>
                    <li><a title="<?php echo tr_wd('delete'); ?>" href="#" onclick="delete_row(<?php echo " 'posts' ".','.$posts['posts_id'];?>)" class="delete"><?php echo tr_wd('delete'); ?></a> </li>
                  </ul>
                </div>
              </td>
                <td><?php echo $sl++;?></td>
