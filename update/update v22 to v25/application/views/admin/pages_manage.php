    ...
    <div class="col-sm-12">
        <div class="btn-group dropdown pull-right">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo base_url().'admin/pages/published'?>"><?php echo tr_wd('published'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/pages/unpublished'?>"><?php echo tr_wd('unpublished'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/pages/'?>"><?php echo tr_wd('all_pages'); ?></a></li>
          </ul>
        </div>
            ...
            <tr id='row_<?php echo $page['page_id'];?>'>              
              <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a target="_blank" href="<?php echo base_url() . 'page/'. $page['slug'];?>"><?php echo tr_wd('preview'); ?></a></li>
                      <li><a  href="<?php echo base_url() . 'admin/pages_edit/'. $page['page_id'];?>"><?php echo tr_wd('edit_page'); ?></a></li>
                      <?php if($page['deletable']!=0): ?>
                      <li><a title="<?php echo tr_wd('delete'); ?>" href="#" onclick="delete_row(<?php echo " 'page' ".','.$page['page_id'];?>)" class="delete"><?php echo tr_wd('delete'); ?></a> </li>
                      <?php endif; ?>     
                    </ul>
                  </div>
              </td>
