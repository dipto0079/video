                ...
                <div class="sendus">
                    ...
                    <div id="contact-form">                        
                        <form class="custom-form" id="login-form" method="post" action="<?php echo base_url().'user/do_login'; ?>">
                            <input type="text" name="username" id="username" class="form-control half-wdth-field" placeholder="User Name" required>
                ...
                <div class="sendus">
                    ...
                    <div id="contact-form">
                        ...
                        <form class="custom-form" id="signup-form" method="post" action="<?php echo base_url().'user/signup/do_signup'; ?>">
                            <input type="text" name="name" id="name" class="form-control half-wdth-field" placeholder="Full Name" required>
                            ...
                            <input type="hidden" name="action" value="submitform">
                            <div>
                                <button type="submit" value="submit" id="submit-btn" class="btn btn-success pull-right"> <span class="btn-label"><i class="fi ion-ios-unlocked-outline"></i></span>Signup </button>
                            </div>
                        </form>
                    </div>
                </div>
