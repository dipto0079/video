                    ...
                    <div class="btn-group">
                        <?php
                            ...
                            foreach($sources as $source):
                                $i++;
                         ?>
                        <a href="<?php echo base_url().'watch/'.$watch_videos->slug.'.html?key='.$source['stream_key']; ?>" class="btn btn-sm <?php if($source['stream_key']==$current_file_id){ echo 'btn-success';}else if($current_file_id=='000000' && $i=='1'){ echo 'btn-success';}else{ echo 'btn-default';} ?>"><?php echo 'Server-'.$i; ?></a>
                        <?php endforeach; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <?php if($watch_videos->is_tvseries =='1'): ?>
                        <div class="row">
                            <div class="col-md-12  m-t-10 m-b-10">
                                <div class="season">
                                <p class="btn btn-inline btn-link">Episodes:</p>
                                    <?php                                       
                                        ...
                                        $episodes = $this->db->get_where('episodes',array('videos_id'=>$watch_videos->videos_id))->result_array();
                                        $i=0;
                                        if(isset($_GET['key'])){
