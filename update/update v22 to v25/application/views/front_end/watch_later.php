                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr id="row_<?php echo $favorite_videos['wish_list_id'];?>">
                                            ...
                                            <td width="70" valign="top">
                                                <a class="btn btn-xs btn-success" href="<?php if($videos['is_tvseries'] =='1'){ echo base_url('tv-series/watch/'.$videos['slug'].'.html');}else{  echo base_url('watch/'.$videos['slug'].'.html');}?>"><i class="fa fa-eye"></i></a>
