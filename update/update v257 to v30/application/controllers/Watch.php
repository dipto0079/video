...
class Watch extends CI_Controller{
    public function index($slug='',$param1='',$param2=''){
        ...
        if($error == FALSE):            
            ...
            $data['og_description']         = !empty(trim($data['watch_videos']->meta_description)) ? $data['watch_videos']->meta_description : $data['watch_videos']->description;
            ...
            $data['meta_description']       = !empty(trim($data['watch_videos']->meta_description)) ? $data['watch_videos']->meta_description : $data['watch_videos']->description;
            $data['focus_keyword']          = $data['watch_videos']->focus_keyword;
