  ...
  <div class="row">
    <div class="col-sm-12">
          ...
          <ul class="dropdown-menu" role="menu">
            <li> <a href="<?php echo base_url().'admin/comments/approved'?>"><?php echo tr_wd('approved'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/comments/unapproved'?>"><?php echo tr_wd('unapproved'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/comments/trash'?>"><?php echo tr_wd('trash'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/comments/spam'?>"><?php echo tr_wd('spam'); ?></a></li>
            <li><a href="<?php echo base_url().'admin/comments/'?>"><?php echo tr_wd('all'); ?></a></li>
          </ul>
        </div>
          <br><br>
          ...
          <tbody>
            ...
            <tr id='row_<?php echo $comments['comments_id'];?>'>                
              <td><div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/comments_edit/'. $comments['comments_id'].'/movie';?>" id="menu" title="<?php echo tr_wd('edit'); ?>" >Edit Comments</a> 
                    <li><a title="<?php echo tr_wd('delete'); ?>" href="#" onclick="delete_row(<?php echo " 'comments' ".','.$comments['comments_id'];?>)" class="delete"><?php echo tr_wd('delete'); ?></a> </li>
                  </ul>
                </div>
              </td>
              <td><?php echo $sl++;?></td>
