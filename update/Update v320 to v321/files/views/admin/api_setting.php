            ...
            <table class="table table-bordered table-striped table-responsive-stack">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>1.0.0</td>
                  <td><textarea rows="3" id="api_v100_url" name="business_address" onclick="copyToClipboard('api_v100_url')" class="form-control"><?php echo base_url('api/v100/') ?></textarea></td>
                  <td>Android: V1.2.0, V1.2.1</td>
                </tr>
              </tbody>
            </table>
            <hr>
            ...
            <table class="table table-bordered table-striped table-responsive-stack">
              ...
              <tbody>
                ...
                ?>
                  <tr>                
                    <td>
                      <input type="text"  id="<?php echo "rest_login_username".$rest_login['id']; ?>" onclick="copyToClipboard('<?php echo "rest_login_username".$rest_login["id"]; ?>')" value="<?php echo $rest_login['username']; ?>" class="form-control"   />
                    </td>

                    <td>
                      <input type="text"  id="<?php echo "rest_login_password".$rest_login['id']; ?>" onclick="copyToClipboard('<?php echo "rest_login_password".$rest_login["id"]; ?>')" value="<?php echo $rest_login['password']; ?>" class="form-control"   />
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            ...
            <table class="table table-bordered table-striped table-responsive-stack">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text"  id="<?php echo "api_key".$key['id']; ?>" onclick="copyToClipboard('<?php echo "api_key".$key["id"]; ?>')" value="<?php echo $key['key']; ?>" class="form-control"   />
                  </td>
                  <td>
