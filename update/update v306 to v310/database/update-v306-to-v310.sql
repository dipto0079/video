...
(NULL, 'recaptcha_enable', '0'),
(NULL, 'recaptcha_site_key', 'xxxxxxxxxxxxxxxxxxx'),
(NULL, 'recaptcha_secret_key', 'xxxxxxxxxxxxxxxxxxxx'),
(NULL, 'az_to_primary_menu', '1'),
(NULL, 'az_to_footer_menu', '1'),
(NULL, 'active_theme', 'default'),
(NULL, 'active_language_id', '1'),
(NULL, 'disqus_short_name', 'ovoo'),
(NULL, 'tmdb_language', 'en'),
(NULL, 'default_quality', 'HD'),
(NULL, 'timezone', 'Asia/Dhaka'),
(NULL, 'season_order', 'DESC'),
(NULL, 'episode_order', 'DESC'),
(NULL, 'video_source', 'mp4'),
(NULL, 'video_file_order', 'DESC'),
(NULL, 'tmbd_api_key', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'),
(NULL, 'slider_border_radius', '10'),
(NULL, 'slider_height', '420'),
(NULL, 'slider_arrow', '1'),
(NULL, 'slider_bullet', '0'),
(NULL, 'slider_fullwide', '0'),
(NULL, 'logo', 'logo.png'),
(NULL, 'favicon', 'favicon.ico'),
(NULL, 'landing_bg', 'landing_page/bg.jpg');
