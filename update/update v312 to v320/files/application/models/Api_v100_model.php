...
class Api_v100_model extends CI_Model {
    ...
    public function get_tv_for_slider($limit=''){
        ...
        foreach ($live_tvs as $live_tv):
            ...
            $response[$i]['image_link']                 = $this->live_tv_model->get_tv_poster($live_tv['live_tv_id']); 
    ...
    **********************/
    ...
    function get_app_config(){
        ...
        $response['program_guide_enable']   = false;//$this->db->get_where('config' , array('title'=>'program_guide_enable'))->row()->value;
